            ...
            <section id="blogs">
                <div className="container services">
                    ...
                    <div className="services-body">
                        <Link className="blog-link" style={{ border: "none" }} to={{ pathname:"https://dev.to/arjun_computer_geek/react-lifecycle-methods-1051" }} target="_blank">
                            <div className="services-item">
                                <div className="icon"><i className="fa fa-cogs fa-3x"></i></div>
                                <h2>React Lifecycle methods</h2>
                                <p>Deatiled Example of React Lifecycle methods. A Class Component based Examples.</p>
                            </div>
                        </Link>
